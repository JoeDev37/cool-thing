  ...
  this.setPath2 = () => {
    if (this.p) {
      if (this.cont) {
        ...
        this.x =
          this.p.x + (this.p.r - this.r) * Math.cos(this.p.a - this.p.a2);
        this.y =
          this.p.y + (this.p.r - this.r) * Math.sin(this.p.a - this.p.a2);
      } else {
...
var addCircle = (c) => {
  ...
  c2.cont = false;
  c2.r = c.r * 0.8;
  if (Math.random() < KF) c2.ka2 = c.ka2 * 0.8;
  ca.push(c2);
  let c3 = new Circle();
  c3.a = TP / 2 + c.a - c.a2;
  c3.dir = c.dir;
  ...
  c3.cont = true;
  c3.r = c.r * 0.8;
  if (Math.random() < 1 - KF) c3.ka2 = c.ka2 * 0.8;
  ca.push(c3);
};
